...
extern bool is_immediate_arithmetic(OpType op_type);

extern bool is_wide_move(OpType op_type);

extern bool is_register_arithmetic_logic(OpType op_type);

extern bool is_register_multiply(OpType op_type);

extern bool is_single_data_transfer(OpType op_type);

extern bool is_load_literal(OpType op_type);

extern bool is_conditional_branch(OpType op_type);

extern bool is_unconditional_branch(OpType op_type);

extern bool is_register_branch(OpType op_type);

extern bool is_branch(OpType op_type);

extern bool is_directive_int(OpType op_type);
